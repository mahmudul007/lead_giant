    ...
    <div class="container clearfix">
        ...
        <div class="mx-auto topmargin" style="max-width: 850px;">
            ...
            <div class="">
                ...
                <form class="row mb-0" enctype="multipart/form-data"
                    action="{{route('contact.request')}}" method="post">
                    @csrf



                    <div class="col-md-6 mb-4">
                        <input type="text" id="template-contactform-name" name="normal_contact_name"
                    ...
                    <div class="col-md-8 mb-4">
                        <input type="text" id="template-contactform-subject" name="normal_contact_subject"
                    ...
                    <div class="col-12 mb-4">
                        <textarea class="required sm-form-control border-form-control" id="normal_contact_msg"
                            name="normal_contact_msg" rows="7" cols="30" placeholder="Your Message"></textarea>
                    </div>
